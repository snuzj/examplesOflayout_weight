...
import com.example.myapplication.databinding.ActivityTenthExampleBinding

class TenthExampleActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTenthExampleBinding
    private var isMainLlVisible = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTenthExampleBinding.inflate(layoutInflater)
